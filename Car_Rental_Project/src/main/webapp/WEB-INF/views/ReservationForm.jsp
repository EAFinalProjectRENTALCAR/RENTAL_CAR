...
<body>
<div align="center">
        <form:form action="reservation" method="post" commandName="reservationForm">
            <table border="0">
                <tr>
                ...
                <tr>
                    ...
                    <td><form:input path="pickUpDate" class="datepicker" /></td>
                    <form:errors path="pickUpDate" cssStyle="color : red;" />
                </tr>
                <tr>
                    <td>Return Date (mm/dd/yyyy):</td>
                    <td><form:input path="returnDate" class="datepicker"  /></td>
